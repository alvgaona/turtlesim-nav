...
static const _GoTo_Request_type_support_symbol_names_t _GoTo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, follow_path, srv, GoTo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, follow_path, srv, GoTo_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, follow_path, srv, GoTo_Request)() {
  return &::follow_path::srv::rosidl_typesupport_c::GoTo_Request_message_type_support_handle;
}
...
static const _GoTo_Response_type_support_symbol_names_t _GoTo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, follow_path, srv, GoTo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, follow_path, srv, GoTo_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, follow_path, srv, GoTo_Response)() {
  return &::follow_path::srv::rosidl_typesupport_c::GoTo_Response_message_type_support_handle;
}
...
static const _GoTo_type_support_symbol_names_t _GoTo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, follow_path, srv, GoTo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, follow_path, srv, GoTo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, follow_path, srv, GoTo)() {
  return &::follow_path::srv::rosidl_typesupport_c::GoTo_service_type_support_handle;
}
