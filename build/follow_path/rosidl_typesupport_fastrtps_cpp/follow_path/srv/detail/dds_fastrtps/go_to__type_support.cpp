...
#include "follow_path/srv/detail/go_to__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_follow_path
cdr_serialize(
  const follow_path::srv::GoTo_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  follow_path::srv::GoTo_Request & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = follow_path::srv::GoTo_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const follow_path::srv::GoTo_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<follow_path::srv::GoTo_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_follow_path
const rosidl_message_type_support_t *
get_message_type_support_handle<follow_path::srv::GoTo_Request>()
{
  return &follow_path::srv::typesupport_fastrtps_cpp::_GoTo_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, follow_path, srv, GoTo_Request)() {
  return &follow_path::srv::typesupport_fastrtps_cpp::_GoTo_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_follow_path
cdr_serialize(
  const follow_path::srv::GoTo_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  follow_path::srv::GoTo_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = follow_path::srv::GoTo_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const follow_path::srv::GoTo_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<follow_path::srv::GoTo_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &follow_path::srv::typesupport_fastrtps_cpp::_GoTo_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, follow_path, srv, GoTo_Response)() {
  return &follow_path::srv::typesupport_fastrtps_cpp::_GoTo_Response__handle;
}
...
{
  return &follow_path::srv::typesupport_fastrtps_cpp::_GoTo__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, follow_path, srv, GoTo)() {
  return &follow_path::srv::typesupport_fastrtps_cpp::_GoTo__handle;
}
