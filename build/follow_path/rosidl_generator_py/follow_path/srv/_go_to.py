...
class Metaclass_GoTo_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('follow_path')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GoTo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from follow_path.srv import _go_to
...
class GoTo(metaclass=Metaclass_GoTo):
    from follow_path.srv._go_to import GoTo_Request as Request
    from follow_path.srv._go_to import GoTo_Response as Response
